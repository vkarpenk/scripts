...
export LD_PRELOAD="/home/vkarpenk/isal/qatzip/QATzip/test/gnr/isa-l/build/igzip/shim/isal-shim.so"
...
NUM_THREADS=1
NUM_CORES=1
numactl -C 4 ./../qatzip-test -m 4 -l 100 -t $NUM_THREADS -B 1 -D $SERVICE -L $LEVEL -i ../calgary_corpus -T $HUFFMAN -C $BLOCKSIZE  -O gzip -g none > result_raw_0 2> result_stderr_0 &
echo "numactl -C 4 ./../qatzip-test -m 4 -l 100 -t $NUM_THREADS -B 1 -D $SERVICE -L $LEVEL -i ../calgary_corpus -T $HUFFMAN -C $BLOCKSIZE -O gzip  -g none > result_raw_0 2> result_stderr_0 &"
...
RESULT_TABLE="performance_table-shim-gnrsp-nt.tsv"
